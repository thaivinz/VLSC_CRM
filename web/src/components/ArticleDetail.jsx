...
export default function ArticleDetail({ path }) {
  ...
  // Extract ID from path like /tin-tuc/1 or /thong-bao/5
  const idMatch = path.match(/\/(?:tin-tuc|thong-bao)\/(\d+)/);
  ...
  if (loading) {
    return (
      <div className="min-h-[500px] flex items-center justify-center bg-[#eff6ff]">
        <div className="text-lg text-gray-500">Đang tải nội dung...</div>
      </div>
    );
  }
